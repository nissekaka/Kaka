...
enum
{
	...
	// TAA
	PS_TAA_SLOT_CURRENT = 1u,
	PS_TAA_SLOT_HISTORY = 2u,
	//PS_TAA_SLOT_WORLDPOS = 2u, // TODO Is not needed if depth is used
	PS_TAA_SLOT_DEPTH = 0u, // TODO Should not be at slot 3
	// Sky
	...
	PS_RSM_SLOT_DEPTH = 6u,
	PS_RSM_SLOT_DIRECTIONAL = 7u,
